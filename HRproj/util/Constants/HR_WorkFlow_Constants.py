class Constants1():
    ...
    STAGE_GMA = 'GM Approval'
    STAGE_FCA = 'FC Approval'
    APP_STATUS_N = 'N'
    STAGE_A = 'Approved'
    STAGE_R = 'Rejected'
    STAGE_JP_BHA = 'BH Approval'
    ...
    STAGE_CHMA = 'HM Candidate Approval'
    HM_CANDIDATE_APPROVAL = "HM Candidate Approved"
    HM_CANDIDATE_REJECTED = "HM Candidate Rejected"

    STAGE_BH_CANDIDATE_APPROVAL = "BH Candidate Approval"
    BH_CANDIDATE_APPROVAL = "BH Candidate Approved"
    BH_CANDIDATE_REJECTED = "BH Candidate Rejected"


    STAGE_FC_Approval = "FC Approval"
    FC_Approval = "FC Approved"
    FC_Approval_REJECTED = "FC Approval Rejected"

    STAGE_GM_Approval = "GM Approval"
    GM_Approval = "GM Approved"
    GM_Approval_REJECTED = "GM Approval Rejected"

    HR_OFFER_LETTER_PROCESS = ""

    VERIFY_UPLOADED_DOCS = "Verify Candidate Documents"

    REUPLOAD_REJECTED_DOCS = "Reupload the rejected documents"
    VERIFY_REUPLOADED_DOCS = "Verify the reuploaded documents"