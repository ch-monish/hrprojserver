class Messages1():
    ...
    CAN_PRF_UPDT_SCFL = 'Candidate profile updated successfully'
    Can_PRF_UPDT_FAIL = 'Candidate profile updation failed'
    ...
    JP_CANCEL = 'Job post has been cancelled'
    ...
    ERR_CRTG_JP = 'Exception while creating/updating the Job Post'
    ...
    CAN_CRP = 'Candidate review is pending'
    ...
    UPLOADED_DOCS_VERIFICATION = 'Candidate uploaded documents verification is pending'
